    ...
    <table style={{ width: "100%", borderCollapse: "collapse", marginTop: 16 }}>
      <thead>
        <tr style={{ borderBottom: "var(--border-thick)" }}>
          ...
          <th style={{ textAlign: "left", padding: "8px 12px" }}>Categorias</th>
      ...
      <tbody>
        {products.map((p) => (
          <tr key={p.id} style={{ borderBottom: "1px solid #eee" }}>
            ...
            <td style={{ padding: "10px 12px", color: "var(--primary-red)", fontWeight: 700 }}>
            ...
            <td style={{ padding: "10px 12px", textAlign: "right", display: "flex", gap: 8, justifyContent: "flex-end" }}>
              <button className="btn btn-outline" style={{ padding: "6px 12px", fontSize: 13 }} onClick={() => onEdit(p)}>
                Editar
              </button>
              <button
